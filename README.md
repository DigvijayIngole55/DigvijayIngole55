...
|---------------------|-------------------|
| [👔 AWS Bedrock HR Assistant](https://github.com/DigvijayIngole55/aws-bedrock-hr-assistant) | Enterprise HR management system built with AWS Bedrock Agents, Lambda functions, and SQLite. Features intelligent vacation management, natural language queries, and automated employee assistance. **Serverless architecture** with integrated IAM security and comprehensive error handling. |
...
**Specialized:** LangGraph, RAG Systems, Transformers, Gemini 2.0 Flash, Gemini 2.5 Flash, Whisper, Deepgram, Pipecat-ai, AWS Bedrock, Boto3
...
**Additional:** FastAPI, Swift, WebSocket, RESTful APIs, AWS Lambda, Serverless
...
**Vector & Specialized:** Weaviate, Qdrant, Redis, Firebase, GCP, Tesseract.js OCR, SQLite, IAM, CloudWatch
